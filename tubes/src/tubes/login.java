...
public class login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Username.setFont(new java.awt.Font("Tekton Pro", 1, 24)); // NOI18N
        ...
        jLabel3.setText("GRAHA BINJAI MOTOR");

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/tubes/image/mc.png"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(nama.equals("Abadi")||nama.equals("Egy")&& password.equals("12345")){
            JOptionPane.showMessageDialog(this,"Login Berhasil!","Success",JOptionPane.INFORMATION_MESSAGE);
            this.dispose();
            new Tampilan().setVisible(true);
        }
        else{
            JOptionPane.showMessageDialog(this,"Login Berhasil!","Error",JOptionPane.ERROR_MESSAGE);
        }
